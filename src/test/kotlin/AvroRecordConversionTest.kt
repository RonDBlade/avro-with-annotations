...
class AvroRecordConversionTest {
    ...
    @Test
    fun `test conversion of basic data builder stuff`() {
        val data = BasicObject.newBuilder()
    ...
    @Test
    fun `converting list values builder stuff`() {
        val data = ListsObject.newBuilder()
    ...
    @Test
    fun `converting maps values builder stuff`() {
        val data = MapsObject.newBuilder()
    ...
    @Test
    fun `list and maps together builder conversion`() {
        val data = ListsAndMapsTogether.newBuilder()
